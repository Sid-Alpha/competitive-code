...
@Question(url = "https://leetcode.com/explore/interview/card/top-interview-questions-medium/110/sorting-and-searching/799/")
@Enhance(
        complexity = Stat.TIME,
        details = "Your algorithm's time complexity must be better than O(n log n), where n is the array's size."
)
public class TopKFrequentElements {
    ...
    public int[] topKFrequent(int[] nums, int k) {
        ...
        List<Map.Entry<Integer, Integer>> l = new ArrayList<>(info.entrySet());
        l.sort((s1, s2) -> {
        ...
        int count = 0;
        while (count < k) finalArr[count] = l.get(count++).getKey();
